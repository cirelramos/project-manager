...
// importar el buscador y paginador
...
// exportamos una constante recibe un objeto que tiene la coleccion de la bd, los campos donde
// realizará las búsquedas, el motor 
export const ProjectsIndex = new EasySearch.Index({
       
       collection: Projects,
       fields: ['name','summary'],
       engine: new EasySearch.Minimongo(),
       defaultSearchOptions: {limit: 2}  // para la paginación
